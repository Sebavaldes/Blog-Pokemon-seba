...
import { Container, Row, Col, Card, CardBody, CardText, Badge, Progress, Button, Modal, ModalHeader, ModalBody, ModalFooter } from 'reactstrap';
                    ...
                    <Card className='shadow mt-3 mb-3'>
                        <CardBody className='mt-3'>
                            ...
                            <Row className={loadClass}>
                                <Col md='12'>
                                    <img src='/img/cargando2.gif' className='w-100'></img>
                                </Col>
                            </Row>
                            <Row className={cardClass}>
                                ...
                                {listaEvoluciones.map((pok, i) => (
                                    <PokeTarjeta poke={pok} key={i} addToFavorites={addToFavorites} />
                                ))}
                            </Row>
                        </CardBody>
                    </Card>
